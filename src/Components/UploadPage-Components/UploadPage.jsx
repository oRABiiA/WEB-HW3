...
const UploadPage = ({ setCurrentPage, user }) => {
  ...
  const validateJSON = (jsonData) => {
    ...
    if (jsonData[0].type) { // check if the file has a type property
      setFileError("");
      setSelectedFile(null);
      const chartType = jsonData[0].type.toLowerCase(); // get the type in the file and make it lowercase to avoid confusions

      // check if type in validType dictionary
      ...
      // check if type in validCircularTypes dictionary
      ...
      // check if type is a bubble chart
      ...
      // check if type is a scatter chart
      ...
      // if none of the valid charts are supported
      else {
        setFileError("Error: Chart type is not supported");
        return false;
      }
    }
    // JOSN does not include type property
    else {
  ...
  return (
      ...
      >
        {/* Container for the floating button to go back to the home page */}
        <div
        ...
        >
          ...
          >
            {/* Image icon for the back button */}
            <img
                src={BackArrow}
                alt="Back"
        ...
        <div className="mx-auto max-w-6xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          ...
          >
            {/* Background decoration using an SVG circle */}
            <svg
            ...
            {/* Text content and actions for uploading and creating charts */}
            <div className="mx-auto max-w-md text-center lg:mx-0 lg:flex-auto lg:py-32 lg:text-left">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6 lg:justify-start">
                {/* Button to navigate to the chart creation page */}
                <button
            ...
            {/* Visual greeting with an SVG icon */}
        ...
        {/* Additional information card component */}
        <InfoCard />
      </div>
  );
};
 ...
 * This prop is required and should be a function.
 */
